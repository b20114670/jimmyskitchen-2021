...
if (document.querySelector("#home-page")) {
  ...
  */ 
  ...
  handleMobileNav(hamburgerLinks, 2, "index.html"); 
  /* 
...
if (document.querySelector("#about-page")) {
  ...
  handleMobileNav(hamburgerLinks, 1, "about.html"); 
} 
if (document.querySelector("#handle-bookings-page")) {
  ...
  handleMobileNav(hamburgerLinks, 1, "handle-bookings.html"); 
} 
...
function handleMobileNav(hamburgerLinks, scrollableLinks) {
    ...
    mobileNav.innerHTML = "";
    hamburgerLinks.forEach((link, index, url) => {
